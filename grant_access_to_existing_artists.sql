-- Grant access to all existing artists for the admin user
...
-- 2. Grant full access to all existing artists
DO $$
DECLARE
    admin_user_id UUID;
...
-- 3. Verify the grants were created
SELECT 
...
-- 4. Show all artist access grants
SELECT 
